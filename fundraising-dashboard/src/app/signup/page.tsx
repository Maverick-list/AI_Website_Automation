...
export default function SignupPage() {
  ...
  const handleSignup = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      login({
        name: name || "New User",
        email: method === "email" ? inputValue : "user@ai.com",
        avatar: name ? name.charAt(0).toUpperCase() : "NU",
        role: "User",
      });
    }, 1500);
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden font-sans">
      ...
      <motion.div
        ...
        className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-blue-500/20 rounded-full blur-3xl pointer-events-none"
      />
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-foreground/60 text-sm">Join MaveCode AI and automate your business.</p>
        </div>
        ...
        <div className="flex items-center space-x-4 mb-6">
          ...
          <span className="text-foreground/40 text-sm">or sign up with</span>
          <div className="h-px bg-sidebar-border flex-1" />
        </div>
